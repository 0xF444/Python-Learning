...
# join() --> joins a list or a tuple into a string and each element is seperated by the string it is connected to <string>.join(list)
# --------------------------------------------------------------------------------
...
# string repeat: print("{whatever}" * n)
# -------------------------------------------------------------------------------------------------------------------------------------------------------------------
#                                       NUMBERS
